 ...
 */
#define RT_LIST_OBJECT_INIT(objec) { &(object), &(object)}
 ...
 */
rt_inline int rt_list_empty(const rt_list_t *l)
{
    return l->next == l;
}
...
rt_inline rt_slist_insert(rt_slist_t *l, rt_slist_t *n)
{
    n->next = l->next;
    l->next = n;
}
...
rt_inline rt_slist_isempty(rt_slist_t *l)
{
