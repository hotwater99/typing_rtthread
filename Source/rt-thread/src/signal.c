...
__done:
    ...
    while (si_node)
    {
        ...
        si_prev = si_node;
        si_node = (void *)rt_list_entry(si_node->list.next, struct siginfo_node, list);
    }
...
void rt_thread_alloc_sig(rt_thread_t tid)
{
    ...
    {
        vector[index] = _sig_default_handler;
    }
...
int rt_thread_kill(rt_thread_t tid, int sig)
{
    ...
    {
        dbg_log(DBG_LOG, "The allocation of signal info node failed.\n");
    }
